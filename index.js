...
let urd = marks.urdu;
let sindh = marks.sindhi;
let mth = marks.math;
let pysic = marks.physics;
let bio = marks.biology;
let pkstudy = marks.pakistanstudies;
let islam = marks.islamiat;
let totleMarks = 800;
let obtainMrks = eng + urd + sindh + mth + pysic + bio + pkstudy + islam;
